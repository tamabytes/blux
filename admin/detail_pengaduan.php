...
<div class="card shadow">
    <div class="card-header">
        <a href="admin/index.php?url=lihat_pengaduan" class="btn btn-primary btn-icon-split">
    ...
    <div class="card-body">
        <form method="post" action="admin/proses_pengaduan.php" enctype="multipart/form-data">
